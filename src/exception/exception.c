...
int exception_handler(t_map map)
{
	...
	i = -1;
	handle_code = 0;
	exception[0] = (t_exception){102, "Header Count", header_count_error};
	exception[1] = (t_exception){103, "Header Location", header_location_error};
	exception[2] = (t_exception){404, "Up", map_error};
	exception[3] = (t_exception){403, "Left", map_error};
	exception[4] = (t_exception){402, "Right", map_error};
	exception[5] = (t_exception){401, "Down", map_error};
	exception[6] = (t_exception){204, "Item Single", item_single_error};
